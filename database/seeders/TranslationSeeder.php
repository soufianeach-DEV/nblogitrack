...
class TranslationSeeder extends Seeder
{
    ...
    private const TEXTES = [
        ...
        'demandes' => [
            ...
            'entreprise_proposee' => ['Proposée d\'après le numéro de TVA ou l\'e-mail saisis par le demandeur (:tva, :email) : vérifiez que la demande vient bien de cette entreprise.', 'Voorgesteld op basis van het btw-nummer of het e-mailadres van de aanvrager (:tva, :email): controleer of de aanvraag echt van dit bedrijf komt.', 'Suggested from the VAT number or email entered by the requester (:tva, :email): check that the request really comes from this company.'],
            'entreprise_inconnue' => ['Aucune entreprise validée n\'a ce numéro de TVA ni cette adresse e-mail. Choisissez-la, ou créez d\'abord son compte.', 'Geen gevalideerd bedrijf heeft dit btw-nummer of dit e-mailadres. Kies het, of maak eerst het account aan.', 'No validated company has this VAT number or email address. Choose it, or create its account first.'],
            'creation_en_cours' => ['Création…', 'Aanmaken…', 'Creating…'],
            'creer_commande' => ['Créer la commande', 'Bestelling aanmaken', 'Create the order'],
        ...
        'devis' => [
            ...
            'choix_client_regulier_entreprise' => ['Je suis déjà client de NBLogiTrack', 'Ik ben al klant bij NBLogiTrack', 'I am already a NBLogiTrack customer'],
            'choix_nouvelle_entreprise' => ['Première demande : je ne suis pas encore client', 'Eerste aanvraag: ik ben nog geen klant', 'First request: I am not a customer yet'],
            'choix_intermediaire_commissionnaire' => ['Je demande pour une autre entreprise (commissionnaire, transitaire)', 'Ik vraag aan voor een andere onderneming (commissionair, expediteur)', 'I am requesting for another company (freight forwarder)'],
            'relation' => ['Votre relation avec NBLogiTrack', 'Uw relatie met NBLogiTrack', 'Your relationship with NBLogiTrack'],
            'client_final' => ['Entreprise pour laquelle vous demandez', 'Onderneming waarvoor u aanvraagt', 'Company you are requesting for'],
            'client_final_ex' => ['Ex : Brasserie Dupont SA', 'Bv. Brouwerij Dupont nv', 'E.g. Dupont Brewery Ltd'],
            'client_final_aide' => [
                'Vos coordonnées restent celles de votre société ; le transport est réalisé pour cette entreprise.',
                'Uw gegevens blijven die van uw onderneming; het transport wordt voor deze onderneming uitgevoerd.',
                'Your details remain those of your company; the transport is carried out for this company.',
            ],
            'choix_national_belgique' => ['National (Belgique)', 'Nationaal (België)', 'Domestic (Belgium)'],
            'choix_international_union_europeenne' => ['Export depuis la Belgique', 'Export vanuit België', 'Export from Belgium'],
            'consigne_fragile' => ['Marchandise fragile', 'Breekbare goederen', 'Fragile goods'],
            'consigne_gerber' => ['Ne pas gerber', 'Niet stapelen', 'Do not stack'],
            'consigne_sangles' => ['Sanglage renforcé', 'Extra sjorren', 'Reinforced strapping'],
            'consigne_appeler' => ['Appeler le destinataire avant la livraison', 'De ontvanger bellen vóór de levering', 'Call the consignee before delivery'],
            'consigne_documents' => ['Documents à remettre au destinataire', 'Documenten af te geven aan de ontvanger', 'Documents to hand over to the consignee'],
            'temp_frais' => ['Frais (2 à 8 °C)', 'Gekoeld (2 tot 8 °C)', 'Chilled (2 to 8 °C)'],
            'temp_surgele' => ['Surgelé (-25 à -18 °C)', 'Diepvries (-25 tot -18 °C)', 'Frozen (-25 to -18 °C)'],
            'temp_tempere' => ['Tempéré (15 à 25 °C)', 'Getemperd (15 tot 25 °C)', 'Ambient (15 to 25 °C)'],
            'date_demain' => ['Prochain jour ouvré', 'Volgende werkdag', 'Next working day'],
            'date_apres_demain' => ['Dans 2 jours ouvrés', 'Over 2 werkdagen', 'In 2 working days'],
            'date_lundi' => ['Lundi prochain', 'Volgende maandag', 'Next Monday'],
            'livraison_meme_jour' => ['Le jour même', 'Dezelfde dag', 'Same day'],
            'livraison_plus_1' => ['+1 jour ouvré', '+1 werkdag', '+1 working day'],
            'livraison_plus_2' => ['+2 jours ouvrés', '+2 werkdagen', '+2 working days'],
            'livraison_plus_3' => ['+3 jours ouvrés', '+3 werkdagen', '+3 working days'],
            'valeur_aide2' => ['Facultatif. Assurance : :tranche', 'Optioneel. Verzekering: :tranche', 'Optional. Insurance: :tranche'],
            'sans_detail' => ['Pas le détail des colis ? Indiquez seulement le poids et le volume', 'Geen detail van de colli? Geef enkel gewicht en volume op', 'No package details? Just give the weight and volume'],
            'reponse_vite' => ['Dès que possible', 'Zo snel mogelijk', 'As soon as possible'],
            'reponse_48h' => ['Sous 48 h', 'Binnen 48 u', 'Within 48 h'],
            'reponse_semaine' => ['Cette semaine', 'Deze week', 'This week'],
            'reponse_pas_presse' => ['Pas pressé', 'Geen haast', 'No rush'],
            'recapitulatif' => ['Récapitulatif', 'Overzicht', 'Summary'],
            'contact' => ['Contact', 'Contact', 'Contact'],
            'dates' => ['Dates', 'Data', 'Dates'],
            'trajet_national' => ['national', 'nationaal', 'domestic'],
            'trajet_intracommunautaire' => ['intracommunautaire', 'intracommunautair', 'intra-EU'],
            'trajet_hors_ue' => ['hors Union européenne (douane)', 'buiten de Europese Unie (douane)', 'outside the European Union (customs)'],
            'autres_horaires' => ['Autres horaires…', 'Andere uren…', 'Other hours…'],
            'plus_details' => ['Contact et accès (facultatif)', 'Contact en toegang (optioneel)', 'Contact and access (optional)'],
        ...
        'pdf' => [
            ...
            'conditions_echeance' => ['Payable au plus tard le :date, sans escompte. À défaut de paiement à l\'échéance, sont dus de plein droit un intérêt de retard au taux de la loi du 2 août 2002 et une indemnité forfaitaire de 40 € pour frais de recouvrement (article 9 des conditions générales).', 'Betaalbaar uiterlijk op :date, zonder korting. Bij niet-betaling op de vervaldag zijn van rechtswege verschuldigd: een verwijlintrest tegen de rentevoet van de wet van 2 augustus 2002 en een forfaitaire vergoeding van 40 € voor invorderingskosten (artikel 9 van de algemene voorwaarden).', 'Payable by :date at the latest, without discount. If unpaid when due, late-payment interest at the rate of the Act of 2 August 2002 and a fixed sum of €40 for recovery costs are owed by operation of law (Article 9 of the general terms).'],
        ...
        'msg' => [
            ...
            'devis_client_non_commandable' => ['Cette entreprise ne peut pas recevoir de commande : elle doit être validée et avoir un compte actif autorisé à commander.', 'Dit bedrijf kan geen bestelling ontvangen: het moet gevalideerd zijn en een actief account hebben dat mag bestellen.', 'This company cannot receive an order: it must be validated and have an active account allowed to order.'],
            'devis_delai_intenable' => ['Aucune formule ne livre le :date avec un enlèvement le :enlevement : convenez d\'une autre date avec le demandeur.', 'Geen formule levert op :date met een ophaling op :enlevement: spreek een andere datum af met de aanvrager.', 'No service delivers on :date with a pickup on :enlevement: agree on another date with the requester.'],
            'devis_enlevement_decale' => ['L\'enlèvement a été reporté au :date (date demandée passée ou non ouvrable).', 'De ophaling is verplaatst naar :date (gevraagde datum verstreken of geen werkdag).', 'The pickup was moved to :date (requested date past or not a working day).'],
