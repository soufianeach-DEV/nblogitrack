...
class TranslationSeeder extends Seeder
{
    ...
    private const TEXTES = [
        ...
        'devis' => [
            ...
            'choix_client_regulier_entreprise' => ['Déjà client chez NBLogiTrack', 'Al klant bij NBLogiTrack', 'Already a NBLogiTrack customer'],
            'choix_nouvelle_entreprise' => ['Nouveau client (première demande)', 'Nieuwe klant (eerste aanvraag)', 'New customer (first request)'],
            'choix_intermediaire_commissionnaire' => ['Commissionnaire ou transitaire (pour le compte d\'un client)', 'Commissionair of expediteur (voor rekening van een klant)', 'Freight forwarder (on behalf of a client)'],
            'vous_etes_aide' => [
                'Commissionnaire ou transitaire : précisez le client final à l\'étape « Précisions ».',
                'Commissionair of expediteur: vermeld de eindklant bij de stap « Details ».',
                'Freight forwarder: name the end client in the « Details » step.',
            ],
