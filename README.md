...
| **Tests et intégration continue** | 88 tests sur PostgreSQL, exécutés à chaque proposition de fusion | ✅ beta |
...
Quatre-vingt-huit tests couvrent l'authentification, le cloisonnement entre rôles, le calcul du prix au serveur, l'interface de programmation, la facturation et l'acceptation des conditions à l'inscription. Le style du code PHP suit la convention Laravel, vérifiée par Pint.
